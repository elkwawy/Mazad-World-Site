...
const AuctionCardHome = ({ auction }) => {
  ...
  return (
    <div className="bg-gray-100 mt-1 p-8  pb-6 rounded-lg relative overflow-hidden">
      ...
      <h2 className="sm:text-2xl  xl:text-3xl text-xl font-bold mt-3 mb-4">
        {auction.title.slice(0, 64)}
      </h2>
      <p className="text-gray-600 max-sm:text-sm  mb-6 max-w-md">
        {auction.description.slice(0, 106)}...
      </p>
      <Link
        ...
        } text-white text-sm  px-6 py-3 rounded-full transition-colors`}
      >
      ...
      <div className="pt-12">
        <img
          ...
          alt="Auction Image"
          className="max-w-full rounded-2xl -m-4 float-end w-[260px] h-[210px] object-fill"
        />
      </div>
    </div>
  );
